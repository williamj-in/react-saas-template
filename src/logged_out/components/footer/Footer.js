...
const infos = [
  {
    icon: <PhoneIcon />,
    description: '+1 412 9044239',
  },
  {
    icon: <MailIcon />,
    description: 'etc-voicers@lists.andrew.cmu.edu',
  },
];
...
function Footer(props) {
  ...
  return (
    <footer className="lg-p-top">
      <WaveBorder upperColor="#f5f5f5" lowerColor={theme.palette.common.darkBlack} animationNegativeDelay={4} />
